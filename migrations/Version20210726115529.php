 ...
 */
final class Version20210726115529 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE review ADD CONSTRAINT review_ibfk_1 FOREIGN KEY (movie_id) REFERENCES movie (id) ON DELETE CASCADE');
    }
}
